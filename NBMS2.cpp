...
class Notice
{
	public :
		...
		void exam_routines(void);
		void results(void);
		void class_routines(void);
} ;
...
initwindow(1000,700,"insert image");
...
line(12,125,350,125);
setcolor(BLACK);
outtextxy(40,140," U P D A T E  N E W S  &  E V E N T S ");
...
line(12,190,350,190);
setcolor(BLACK);
outtextxy(40,205," U P D A T E  A C A D E M I C  P R O G R A M S ");
...
line(12,255,350,255);
setcolor(BLACK);
outtextxy(40,270," U P D A T E  E X A M  R O U T I N E S ");
...
line(12,320,350,320);
setcolor(BLACK);
outtextxy(40,335," U P D A T E  R E S U L T S ");
...
line(12,385,350,385);
setcolor(BLACK);
outtextxy(40,400," U P D A T E  C L A S S   R O U T I N E S ");
...
descision:if(u.compare(user)==0 && p.compare(pass)==0)
{
    setcolor(BLACK);
    gotoxy(25,20);
    cout<<a;
...
//system("cls");
    string notice_;
    ofstream file_("notice1.txt",ios_base::app);
    if(!file_)
   {
